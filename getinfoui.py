...
class HOTEL_MANAGEMENT:
    def __init__(self):
            ...
            try:
                ...
                while True:
                    ...
                    if self.gettininfo == a:
                        n = 1
                        self.Text1.insert(INSERT, "İSİM-", "\t", "\t", s.name)
                        self.Text1.insert(INSERT, "\n")
                        self.Text1.insert(INSERT, "ADRES-", "\t", s.address)
                        self.Text1.insert(INSERT, "\n")
                        self.Text1.insert(INSERT, "TEL NO.-", "  ", s.mobile_no)
                        self.Text1.insert(INSERT, "\n")
                        self.Text1.insert(INSERT,"FATURA:", s.price,"₺ (tl)")
                        self.Text1.insert(INSERT, "\n")
                    elif EOFError:
                        if n == 0:
                            print("BU ODADA BİR ZİYARETÇİ KALMAMAKTA ", self.gettininfo)
                        else:
                            n = 0
                            continue
            except EOFError:
        ...
        self.Label1.configure(text='''ODA NO. GİR   :''')
        ...
        self.Button1.configure(text='''GÖNDER''')
        ...
        self.Message1.configure(text='''BURADAN BİLGİ AL !!!''')

...
class New_Toplevel:
    ...
    def __init__(self):
        def check_room():
            ...
            if self.rom.isdigit() == True and len(self.rom) != 0:
                ...
                try:
                    ...
                    if n == 0:
                        self.Text1.insert(INSERT, "ZİYARETÇİ BULUNAMADI!""\n")

                    elif n == 1:

                        self.Text1.insert(INSERT, "BİZİ TERCİH ETTİĞİNİZ İÇİN TEŞEKKÜRLER " + name1.upper()+"!""\n")
                    pass
                f.close()
                f1.close()
                os.remove("hotel.dat")
        ...
        self.Button1.configure(text='''SİL!!!''')

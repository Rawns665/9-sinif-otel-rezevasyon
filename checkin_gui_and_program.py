...
class HOTEL_MANGMENT_checkin:
    ...
    def __init__(self):
        ...
        def chk_name():
            while True:
                ...
                if len(self.k) != 0 and a != True:
                    self.NAME=self.k
                    self.Text1.insert(INSERT, "İSİM KAYDEDİLDİ""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "GEÇERSİZ İSİM LÜTFEN GEÇERLİ BİR AD GİRİNİZ""\n")
        ...
        def chk_add():
            while True:
                ...
                if len(self.g)!= 0 and ak!=True:
                    ...
                    self.Text1.insert(INSERT, "ADRES KAYDEDİLDİ""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "GEÇERSİZ ADRES LÜTFEN GEÇERLİ BİR ADRES GİRİN""\n")
        ...
        def chk_mo():
            while True:
                ...
                if self.h.isdigit() == True and len(self.h) != 0 and len(self.h) == 10:
                    self.MOBILE = self.h
                    self.Text1.insert(INSERT, "TELEFON NUMARASI KAYDEDİLDİ""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "GEÇERSİZ TELEFON NUMARASI LÜTFEN GEÇERLİ BİR TELEFON NUMARASI GİRİN""\n")
                break
        ...
        def chk_day():
            while True:
                ...
                if self.l.isdigit() == True and len(self.l) != 0:
                    ...
                    self.Text1.insert(INSERT, "KALINACAK GÜN SAYISI KAYDEDİLDİ""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "GEÇERSİZ SAYI LÜTFEN GEÇERLİ BİR GÜN SAYISI GİRİNİZ""\n")
                    break
        ...
        self.Message1.configure(text='''OLDUĞUN SAYFA: ''')
        ...
        self.Message3.configure(text='''MÜŞTERİ KAYDI''')
        ...
        self.Label3.configure(text='''ADINI GİR''')
        ...
        self.Label4.configure(text='''TELEFON NUMARANI GİR''')
        ...
        self.Label5.configure(text='''ADRESİNİ GİR''')
        ...
        self.Label6.configure(text='''ODA TÜRÜNÜ SEÇ''')
        ...
        self.Label7.configure(text='''ÖDEME METODUNU SEÇ''')
        ...
        self.Checkbutton5.configure(text='''KREDİ/BANKA KARTI İLE''')
        ...
        self.Checkbutton6.configure(text='''NAKİT''')
        ...
        self.Button4.configure(text='''GÖNDER''')
        ...
        self.Label1.configure(text='''KALACAĞI GÜN SAYISI''')

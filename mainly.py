...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        root.title("OTEL REZERVASYON SİSTEMİ")
        ...
        self.Message6.configure(text='''YİĞİTOĞULLARI OTEL REZERVASYON SİSTEMİNE HOŞGELDİN!!!''')
        ...
        self.Button2.configure(text='''1. MÜŞTERİ KAYDI''')
        ...
        self.Button3.configure(text='''2. ZİYATETÇİ LİSESTESİNİ YAZDIR''')
        ...
        self.Button4.configure(text='''3. MÜŞTERİ SİL''')
        ...
        self.Button5.configure(text='''4. MÜŞTERİ BİLGİLERİNİ AL''')
        ...
        self.Button6.configure(text='''5. ÇIKIŞ''')
